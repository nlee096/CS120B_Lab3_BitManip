...
tests = [ 
    ...
    #2
    {'description': ' PORTA = 0x02 => PORTC = 0x60',
    ...
    #6
    {'description': ' PORTA = 0x06 => PORTC = 0x38',
    ...
    #9
    {'description': ' PORTA = 0x09 => PORTC = 0x3C',
    ...
    #13
    {'description': ' PORTA = 0x0D => PORTC = 0x3F',
     'steps': [ {'inputs': [('PINA', 0x0D)], 'iterations': 1 } ],
     'expected': [('PORTC', 0x3F)],
    },

    #14
    {'description': ' PORTA = 0x0E => PORTC = 0x3F',
